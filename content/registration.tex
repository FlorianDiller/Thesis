...
\begin{itemize}
	\vspace{-0.3cm}\item Vertical alignment (up/down)
	\vspace{-0.3cm}\item Horizontal alignment (left/right \& forward/backward)
	\vspace{-0.3cm}\item Rotation about vertical axis (yaw)
	\vspace{-0.3cm}\item Rotation about horizontal axes (pitch \& roll)
\end{itemize}
...
\begin{figure*}[h]
	...
	\subfloat[Push-up (P)]{\includegraphics[height=.16\linewidth]{pictures/pushupPelvis.PNG}\hfill}  
	\subfloat[Push-up (R)]{\includegraphics[height=.16\linewidth]{pictures/pushupRegistered.PNG}\hfill} 
	\subfloat[Dip (P)]{\includegraphics[height=.27\linewidth]{pictures/dipsPelvis.PNG}\hfill} 
	\subfloat[Dip (R)]{\includegraphics[height=.27\linewidth]{pictures/dipsRegistered.PNG}\hfill} 
	\subfloat[Jump (F)]{\includegraphics[height=.27\linewidth]{pictures/jumpFeet.PNG}\hfill}
	\subfloat[Jump (R)]{\includegraphics[height=.27\linewidth]{pictures/jumpPelvis.PNG}\hfill} 
	\caption{Start and execution position of exercise examples registered according to the registration methods in \autoref{sec:optimalReg} (R), the feet (F) and only the pelvis (P). The exercises and registration parameters can be found in \autoref{tab:regExamples}.}
