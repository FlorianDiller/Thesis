...
\begin{itemize}
	...
	\item What is the state of the art for visualizing motor skill learning in mixed reality?
	\item When using superimposed avatars, how do they have to be registered?
	\item Is there a way to chose viewpoints automatically for visualize motor skill learning feedback?
	\item Can mixed reality be leveraged to support skill learning in an injury-free manner?
\end{itemize}
