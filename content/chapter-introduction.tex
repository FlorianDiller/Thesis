...
\begin{itemize}
	\vspace{-0.3cm}\item Visual cue based corrective feedback for motor skill training in mixed reality: A survey \cite{diller2022vcb}
	\vspace{-0.3cm}\item Automatic Viewpoint Selection for Interactive Motor Feedback Using Principle Component Analysis \cite{diller2024automatic}
	\vspace{-0.3cm}\item Towards an Optimal Display of Superimposed Avatars for Motor Feedback [currently under review]
	\vspace{-0.3cm}\item SkillAR: omnipresent in-situ feedback for motor skill training using AR \cite{diller2024skillar}
	\vspace{-0.3cm}\item Holistic Approach to Modular Open Educational Resources for Computer Graphics \cite{diller2024holistic}
\end{itemize}
