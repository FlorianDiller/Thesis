...
\begin{figure*}[h!]
	...
	\caption[Examples of exocentric and egocentric motion feedback in augmented reality.]{Examples of exocentric (left) and egocentric (right) motion feedback in augmented reality. The possible target movement is in both cases represented by a green avatar. Compare to stylized illustration in \autoref{fig:POV}.}
	\label{fig:POV:AR}
\end{figure*}
