...
\subsection{Point of View in Motor Feedback\label{sec:omnipresent:POV}}
...
\subsection{Common Visual Feedback Technologies} %Methods?
...
\begin{figure*}[h!]
	\centering
	\subfloat[Standing]{\includegraphics[width=.13\linewidth]{pictures/Standing.png}\hfill}  
	\subfloat[Jump. Jack]{\includegraphics[width=.15\linewidth]{pictures/JumpingJack.png}\hfill} 
	\subfloat[Plank]{\includegraphics[width=.19\linewidth]{pictures/Plank.png}\hfill} 
	\subfloat[Squat]{\includegraphics[width=.19\linewidth]{pictures/Squat.png}\hfill} 
	\subfloat[Torso Rot.]{\includegraphics[width=.13\linewidth]{pictures/TorsoRotation.png}\hfill}
	\subfloat[Warrior II]{\includegraphics[width=.22\linewidth]{pictures/WarriorII.png}\hfill} 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{pictures/avatarPos.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{pictures/gridRound.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{pictures/floorPos.png}
